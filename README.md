...
- [hiroxpepe/meowziq](https://github.com/hiroxpepe/meowziq) - MIDI sequencer that reads JSON, in the MeowziQ song format, and plays it back.
...
- [southigator/itunes-to-spotify-playlist](https://github.com/southigator/itunes-to-spotify-playlist) - Mirrored from GitLab
...
- [berend-de-jong/N1-Berend](https://github.com/berend-de-jong/N1-Berend) - A theme for the open source email client Nylas N1
...
- [vishalxl/nostr_console](https://github.com/vishalxl/nostr_console) - Nostr console is a RETIRED ( as of early 2026), open-source twitter-like social network, direct chat app and group chat all bundled into one program. Built on the decentralized Nostr protocol.
...
- [No-Instructions/relay-server-template](https://github.com/No-Instructions/relay-server-template) - Instructions for hosting an on-premise Relay Server
...
- [rocktimsaikia/spotify-rtoken-cli](https://github.com/rocktimsaikia/spotify-rtoken-cli) - Generate a Spotify refresh_token right from the terminal
...
- [o-inha/ChordsGuruTurbo100aDeluxe](https://github.com/o-inha/ChordsGuruTurbo100aDeluxe) - Visualize and preview written chord progressions
...
- [preziotte/party-mode](https://github.com/preziotte/party-mode) - An experimental d3.js music visualizer from 2014. Continued as vizz.fm
...
- [tanaikech/ImgApp](https://github.com/tanaikech/ImgApp) - A powerful image processing library for Google Apps Script (GAS) to retrieve image size/DPI via binary parsing, resize images, update thumbnails, crop/merge images, and perform OCR using Google Drive 
...
- [dxdc/aws-sdk-google-apps](https://github.com/dxdc/aws-sdk-google-apps) - AWS SDK for JavaScript (v2) ported to Google Apps Script - S3, SES, DynamoDB, Lambda, SQS, SNS, EC2, STS
...
- [o-inha/MusicWithChatGPT](https://github.com/o-inha/MusicWithChatGPT) - Tips and tools for writing music with the aid of ChatGPT
...
- [AriHuttunen/claude-skills](https://github.com/AriHuttunen/claude-skills) - Claude Code skills
...
- [paradroidlabs/scratchpad](https://github.com/paradroidlabs/scratchpad) - This framework works as a form of user/machine calibration, with a focus on user-context and user-intent, deconstructing your ideas logically from A to B to Z.
...
- [Anil-matcha/awesome-meta-muse-agent](https://github.com/Anil-matcha/awesome-meta-muse-agent) - Copy-paste Muse agent briefs for practical workflows, connected apps, approvals, and evidence-backed automation.
...
- [conduktor/conduktor-platform](https://github.com/conduktor/conduktor-platform) - The Apache Kafka Operations Platform. 🚀
...
- [agh/slack_themes](https://github.com/agh/slack_themes) - :speech_balloon: Slack Themes 💖 (Est. 2014) | Popular collection of themes for Slack pulled together into one easily referenced place, letting you get a taste before you copy and paste!
...
- [kylegilman/video-embed-thumbnail-generator](https://github.com/kylegilman/video-embed-thumbnail-generator) - A WordPress plugin that generates thumbnails, video players, and pop-up galleries for locally hosted videos. Requires FFMPEG or encoding.
...
- [sec-knight/grimoire](https://github.com/sec-knight/grimoire) - Your tome of knowledge. A Git-native context routing protocol for human/AI work.
...
- [tarkaai/gtm-skills](https://github.com/tarkaai/gtm-skills) - GTM skills for AI agents. 240 plays across Marketing, Sales, and Product. Configure once for your CRM and automation stack.
...
- [baryhuang/mcp-hubspot](https://github.com/baryhuang/mcp-hubspot) - A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while
...
- [geo-martino/mytunes](https://github.com/geo-martino/mytunes) - A Swiss Army knife for programmatic music library management. Manages both local and music streaming service libraries.
...
- [gokayfem/ComfyUI_VLM_nodes](https://github.com/gokayfem/ComfyUI_VLM_nodes) - ComfyUI nodes for vision-language models: Qwen3-VL, Moondream 3, Florence-2, SmolVLM2, InternVL, Gemma 3, MiniCPM-V. Plus open-vocabulary detection, SAM2/SAM3 segmentation, video temporal reasoning, G
...
- [simonrob/email-oauth2-proxy](https://github.com/simonrob/email-oauth2-proxy) - An IMAP/POP/SMTP proxy that transparently adds OAuth 2.0 authentication for email clients that don't support this method. Keep legacy email clients working with Exchange Online, Gmail and other provid
...
- [guyyariv/TempoTokens](https://github.com/guyyariv/TempoTokens) - [AAAI 2024] The official PyTorch implementation of "Diverse and Aligned Audio-to-Video Generation via Text-to-Video Model Adaptation"
- [guyyariv/AudioToken](https://github.com/guyyariv/AudioToken) - [InterSpeech 2023] The official PyTorch implementation of: "AudioToken: Adaptation of Text-Conditioned Diffusion Models for Audio-to-Image Generation"
...
- [RaoFoundation/bittensor](https://github.com/RaoFoundation/bittensor) - Internet-scale Neural Networks
...
- [RhythrosaLabs/soundstorm](https://github.com/RhythrosaLabs/soundstorm) - AI-powered audio manipulation studio — sample pack creation, algorithmic composition, text-to-audio generation, and ChatGPT on one screen
...
- [FuchsiaBytes/twang](https://github.com/FuchsiaBytes/twang) - Library for pure Rust advanced audio synthesis.
...
- [futamura/fzf-brew](https://github.com/futamura/fzf-brew) - Homebrew completion using fzf for zsh
- [futamura/fzf-mise](https://github.com/futamura/fzf-mise) - Mise completion using fzf for zsh
- [futamura/fzf-git-util](https://github.com/futamura/fzf-git-util) - Git, Git Fuzzy, and GHQ completion using fzf for zsh
...
- [FluidInference/FluidUse](https://github.com/FluidInference/FluidUse) - Local computer use on Apple silicon: on-device typed decisions with laya and form filling with CUA-S1-FORMS, driven through the macOS Accessibility API
- [vorssaint/vorssaint-utils](https://github.com/vorssaint/vorssaint-utils) - Free and open-source macOS menu bar toolkit.
- [betocmn/widen](https://github.com/betocmn/widen) - Postgres GUI using the LLM already on your Mac. Free, open-source native macOS database GUI using Apple's on-device Foundation Model for text-to-sql.
...
- [hbmartin/attio-ts-sdk](https://github.com/hbmartin/attio-ts-sdk) - Type-safe TypeScript SDK for the Attio CRM API with Zod v4 runtime validation
- [HeyPuter/browser.js](https://github.com/HeyPuter/browser.js) - Highly Configurable Browser Environment for the Web
...
- [T3-Content/clodo-cli](https://github.com/T3-Content/clodo-cli) - Read-only Clodo CLI and Cloudflare relay for agent-driven contact research
- [Genomewide/lifemail](https://github.com/Genomewide/lifemail) - Give any Claude Code on a Mac access to your email (Outlook via Apple Mail) + the Obsidian skill. Local-only MCP server + skills.
...
- [chenglou/freerange](https://github.com/chenglou/freerange) - Statically verify your layout code
...
- [getcustomaise/customaise-mcp](https://github.com/getcustomaise/customaise-mcp) - MCP server + CLI bridging AI coding agents (Cursor, Claude Code, Codex, Windsurf, Kiro, Antigravity, Claude Desktop) to the Customaise Chrome extension. 19 tools: UserScripts, AgentScripts, WebMCP cal
...
- [Fission-AI/PR-QUEST](https://github.com/Fission-AI/PR-QUEST) - A more interactive & engaging way to review PR's!
...
- [reliverse/experiments](https://github.com/reliverse/experiments) - Experimental projects, prototypes, and early ideas from the Reliverse and Bleverse ecosystems.
...
- [rocktimsaikia/spotify-mini](https://github.com/rocktimsaikia/spotify-mini) - Fetch your currently playing, recent and top Spotify tracks in Node.js
...
- [mailscript/mailscript-cli](https://github.com/mailscript/mailscript-cli) - Get a programmable email address. Automate what happens when you receive emails. It's like Zapier for devs who hate emails.
...
- [dove-analog/plant-db](https://github.com/dove-analog/plant-db) - database application that handles dynamic data about plants
...
- [briansunter/logseq-openai](https://github.com/briansunter/logseq-openai) - A plugin for GPT-3 AI assisted note taking in Logseq
...
- [purduehackers/events](https://github.com/purduehackers/events) - Wtf is going on?? What is Purdue Hackers up to?!?!? Stay tuned & find out here!
...
- [AviPeltz/CursedIDE](https://github.com/AviPeltz/CursedIDE) - An AI coding-agent IDE — implemented in Verilog. Inspired by Superset
